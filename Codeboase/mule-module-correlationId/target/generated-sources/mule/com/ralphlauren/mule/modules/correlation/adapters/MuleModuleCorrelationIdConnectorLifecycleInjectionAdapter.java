...
/**
 * A <code>MuleModuleCorrelationIdConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link MuleModuleCorrelationIdConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.7.1", date = "2017-01-30T02:54:10+05:30", comments = "Build UNNAMED.2613.77421cc")
public class MuleModuleCorrelationIdConnectorLifecycleInjectionAdapter
    extends MuleModuleCorrelationIdConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(MuleModuleCorrelationIdConnectorLifecycleInjectionAdapter.class);
